...
class DownstreamExpert(nn.Module):
    def __init__(self, upstream_dim, downstream_expert, **kwargs):
        ...
        class_weights = self.calc_class_weight(load_file(self.datarc["voiceMOS_path"], "sets/TRAINSET"))
    ...
    def calc_class_weight(self, ld_score_list):
        scores = list(ld_score_list[2])
    ...
    def forward(
        ...
        **kwargs,
        ...
        records["true_scores"] += true_scores.detach().cpu().tolist()
